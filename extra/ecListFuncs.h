 ...
 *
 */
ListType toList(const std::vector<int> & nums);
 ...
 *   A run is an ajacecent sequence two or more of the same values.
 *
 * Examples:
 *  list                   numRuns(list)
 *
...
void splice (ListType & list, int value, ListType sublist);//14Fall//////////////////
